  ...
  return (
    <main className="pricing-page-container container page-fade-in">
      ...
      <p className="pricing-intro">
        Your Aurora '25 pass grants you access to the entire two-day flagship event, including all expert talks, panel discussions, and cultural nights. Specific workshops and competitions may have separate registration steps after you've secured your main pass.
      </p>
